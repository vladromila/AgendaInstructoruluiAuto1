            ...
            <React.Fragment>
                {this.props.class && this.props.student ? <View><ListItem
                    ...
                    {this.state.isVisible === true ?
                        <View>
                            <View style={{ backgroundColor: 'rgba(245, 15, 15, 0.5)', marginLeft: 10, marginRight: 10, alignSelf: 'center', width: '95%', padding: 5 }}>
                            ...
                            <View style={{ backgroundColor: 'rgba(30, 110, 199,0.3)', marginLeft: 10, marginRight: 10, alignSelf: 'center', width: '95%', padding: 5 }}>
